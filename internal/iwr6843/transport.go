...
var ErrTransportClosed = errors.New("IWR6843 D2XX transport is closed")
...
func OpenTransport(ctx context.Context, selectors Selectors) (*Transport, error) {
	...
	return openTransport(ctx, selectors, d2xxBackend{
...
func (selectors Selectors) validate() error {
	...
	spiBase, spiOK := strings.CutSuffix(selectors.SPI.Description, " A")
	irqBase, irqOK := strings.CutSuffix(selectors.IRQ.Description, " B")
...
func openTransport(ctx context.Context, selectors Selectors, backend d2xxBackend) (*Transport, error) {
	if err := selectors.validate(); err != nil {
...
func (transport *Transport) initialize(ctx context.Context) error {
...
func (transport *Transport) SPIWrite(ctx context.Context, payload []byte) error {
	if transport == nil {
...
func (transport *Transport) SPIRead(ctx context.Context, buffer []byte) error {
	if transport == nil {
		return ErrTransportClosed
	}
...
func (transport *Transport) WaitIRQ(ctx context.Context, asserted bool) error {
	if transport == nil {
		return ErrTransportClosed
	}
	transport.lifecycleMu.RLock()
...
func (transport *Transport) withOperationContext(parent context.Context) (context.Context, context.CancelFunc) {
